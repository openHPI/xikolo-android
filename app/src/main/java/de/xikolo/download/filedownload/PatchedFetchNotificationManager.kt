...
/**
 * A patched version of the default notification manager. This is required due to missing support
 * for targeting SDK version 31 and up in the library. See https://github.com/tonyofrancis/Fetch/issues/638
 *
 * */
abstract class PatchedFetchNotificationManager(context: Context) : FetchNotificationManager {
    ...
    override val broadcastReceiver: BroadcastReceiver
        get() = object: BroadcastReceiver() {
            ...
            override fun onReceive(context: Context?, intent: Intent?) {
                onDownloadNotificationActionTriggered(context, intent, this@PatchedFetchNotificationManager)
            }
    ...
    override fun getGroupActionPendingIntent(groupId: Int,
        ...
        synchronized(downloadNotificationsMap) {
            ...
            return PendingIntent.getBroadcast(context, groupId + action, intent, flags)
        }
    }
