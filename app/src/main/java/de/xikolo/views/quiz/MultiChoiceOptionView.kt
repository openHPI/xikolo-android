...
class MultiChoiceOptionView(context: Context, attributeSet: AttributeSet? = null) :
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.item_quiz_question_multi_choice, this, true)
