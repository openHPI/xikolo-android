...
public class VideoPreviewFragment extends PagerFragment<Video> {
    ...
    public static PagerFragment newInstance(Course course, Section module, Item item) {
        return PagerFragment.newInstance(new VideoPreviewFragment(), course, module, item);
    }
        ...
        Result<Item> result = new Result<Item>() {
            ...
            protected void onSuccess(Item result, DataSource dataSource) {
                if (result.detail != null) {
                    ...
                    VideoPreviewFragment.this.item = item;
                }
