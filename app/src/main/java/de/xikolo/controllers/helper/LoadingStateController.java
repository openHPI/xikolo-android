...
public class LoadingStateController {
    ...
    public LoadingStateController(FragmentActivity activity, View view, SwipeRefreshLayout.OnRefreshListener onRefreshListener) {
