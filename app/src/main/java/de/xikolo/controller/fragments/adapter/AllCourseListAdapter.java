...
public class AllCourseListAdapter extends CourseListAdapter {

    public static final String TAG = AllCourseListAdapter.class.getSimpleName();
    ...
    public AllCourseListAdapter(Activity context, OnEnrollButtonClickListener callback) {
